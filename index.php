...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="page/division1.php"><i class="fa fa-circle-o"></i> Cleaning Services</a></li>
            <li><a href="page/division2.php"><i class="fa fa-circle-o"></i> Office Boys</a></li>
            <li><a href="page/division3.php"><i class="fa fa-circle-o"></i> Security</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php 
        include "config/db.php";
        $e_all=mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(id) FROM employee"));
        $e_1=mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(id) FROM employee WHERE division=1"));
        $e_2=mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(id) FROM employee WHERE division=2"));
        $e_3=mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(id) FROM employee WHERE division=3"));
      ?>
