      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Security</a></li>
          </ul>
        </li>
            ...
            <div class="box-body">
              <table class="table table-hover">
                ...
                <?php 
                  include "../config/db.php";
                  $n=1;
                  $rows=mysqli_query($con, "SELECT id,name,phone,year(birthday),gender FROM employee WHERE division = 3");
